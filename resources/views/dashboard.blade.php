        ...
        <div class="bg-white rounded-xl shadow-lg border-2 border-gray-200/50 overflow-hidden">
            <div class="p-6 border-b-2 border-gray-200 bg-gradient-to-r from-pink-50 via-white to-pink-50">
                <div class="flex items-center gap-3">
                    ...
                    <h3 class="text-xl font-bold text-gray-800">Menu Cepat</h3>
                </div>
            </div>
            ...
            <div class="p-6 bg-gradient-to-br from-gray-50 to-white">
                <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
                    @if(auth()->user()->isSuperAdmin())
                    <a href="{{ route('admin.create') }}" class="group flex items-center p-5 bg-gradient-to-br from-pink-500 to-pink-600 rounded-xl hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                        <div class="flex items-center gap-4 w-full">
                            ...
                            <span class="text-sm font-bold text-white">Tambah Admin Baru</span>
                        </div>
                    </a>
                    
                    <a href="{{ route('admin.index') }}" class="group flex items-center p-5 bg-gradient-to-br from-blue-500 to-blue-600 rounded-xl hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                        <div class="flex items-center gap-4 w-full">
                            <div class="p-3 rounded-xl bg-white/20 backdrop-blur-sm shadow-lg">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" />
                            ...
                            <span class="text-sm font-bold text-white">Kelola Admin</span>
                        </div>
                    </a>
                    @endif

                    <a href="{{ route('password.change') }}" class="group flex items-center p-5 bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                        <div class="flex items-center gap-4 w-full">
                            <div class="p-3 rounded-xl bg-white/20 backdrop-blur-sm shadow-lg">
                                <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 7a2 2 0 012 2m4 0a6 6 0 01-7.743 5.743L11 17H9v2H7v2H4a1 1 0 01-1-1v-2.586a1 1 0 01.293-.707l5.964-5.964A6 6 0 1121 9z" />
                            ...
                            <span class="text-sm font-bold text-white">Ganti Password</span>
                        </div>
                    </a>

                    <form method="POST" action="{{ route('logout') }}" class="inline">
                        @csrf
                        <button type="submit" class="group w-full flex items-center p-5 bg-gradient-to-br from-red-500 to-red-600 rounded-xl hover:shadow-xl transition-all duration-300 transform hover:scale-105">
                            <div class="flex items-center gap-4 w-full">
                                <div class="p-3 rounded-xl bg-white/20 backdrop-blur-sm shadow-lg">
                                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
